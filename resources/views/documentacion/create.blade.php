        ...
        <div class="col-lg-6">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p>Browser default validation with using the <code>required</code> keyword. Try submitting the form
                        below. Depending on your browser and OS, you’ll see a slightly different style of feedback.</p>
        ...
        <div class="col-lg-6">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p>For custom Bootstrap form validation messages, you’ll need to add the <code>novalidate</code>
                        boolean attribute to your <code>&lt;form&gt;</code>. This disables the browser default feedback
                        tooltips, but still provides access to the form validation APIs in JavaScript. </p>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p>If your form layout allows it, you can swap the <code>.{valid|invalid}-feedback</code> classes
                        ...
                        require an alternative setup. </p>
...
<section class="section">
    ...
    <form id="wizard-validation-form" action="#" name="formulario" method="post" files="true"
